    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form class="form-horizontal form-label-left">
                    ...
                    <%--<div class="panel panel-success">--%>
                        ...
                        <%--<div class="panel-body"  id="messageC" role="tabpanel" aria-labelledby="message">--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <div class="col-xs-8">
                                        <input type="text" class="Wdate datePicker" id="startTime" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endTime\')||\'2099-12-31\'}'})" required>  至
                                        <input type="text" class="Wdate datePicker" id="endTime" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startTime\')}',maxDate:'2099-12-31'})" required>
                                    </div>
                                    <div class="col-xs-4">
                                        共计<input type="number" class="textInput" style="width:60px;" >天
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <textarea rows="10" class="form-control">最多1000字</textarea>
                                </div>
                            </div>
                ...
                <%--</div>--%>
                <div class="ln_solid"></div>
                <button type="button" class="btn btn-success pull-right"><i class="fa fa-plus"></i>添加</button>
            </form>
        </div>
    </div><%--遮罩背景层--%>
