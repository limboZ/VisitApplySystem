...
<div class="x_panel">
    ...
    <div class="x_content">
        <div class="bg-danger">
            1.出访申请审批环节 ,管理员在提交审批前可以对出访申请中的内容进行编辑和选择流程,提交审批后则不能修改
                ...
                <table class="table ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>经理</td>
                            <td>
                                <button type="button" class="btn btn-default btn-xs"><i class="fa fa-chevron-up"></i>上移</button>
                                <button type="button" class="btn btn-default btn-xs"><i class="fa fa-chevron-down"></i>下移</button>
    ...
    $().ready(function () {
        ...
        $('#addChecker').click(function () {
            ...
            if(message == ''){
                ...
                op += '<td>' + userName + '</td>';
                op += '<td>' + job + '</td>';
                op += '<td><button type="button" class="btn btn-default btn-xs"><i class="fa fa-chevron-up"></i>上移</button>';
                op += '<button type="button" class="btn btn-default btn-xs"><i class="fa fa-chevron-down"></i> 下移</button>';
                op += '<button type="button" class="btn btn-danger btn-xs remove">删除</button>';
                op += '</td></tr>';
                $('#checkerForm').before(op);
                $('#checkerForm').hide();
